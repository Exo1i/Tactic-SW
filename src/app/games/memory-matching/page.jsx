    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col items-center p-2 sm:p-4">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md relative border border-gray-700">
            ...
            {useIpCamera && (
              <>
                ...
                <input
                  ...
                  className="w-full p-2 rounded-md border border-gray-700 bg-gray-900 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition mb-2"
                  onKeyDown={(e) => {
            ...
            <button
              ...
              className="w-full px-4 py-2 rounded-md font-medium shadow transition bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:from-purple-700 hover:to-indigo-700"
            >
              Apply
            </button>
          </div>
      ...
      <div className="w-full max-w-6xl flex justify-end mb-2">
        <button
          ...
          className="px-3 py-1 rounded shadow text-sm font-medium transition bg-gradient-to-r from-purple-400 to-pink-500 text-white hover:from-purple-500 hover:to-pink-600"
        >
          Camera Settings
        </button>
      </div>
