...
// Define SettingsModalComponent outside RubiksSolverPage
const SettingsModalComponent = ({
  showSettings,
  setShowSettings,
  modalCameraSettings,
  setModalCameraSettings,
  ipCameraInputRef, // Changed from ipCameraUrlModalRef for consistency
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md relative">
        ...
        <div className="flex items-center mb-3">
          <input
            type="checkbox"
            id="useIpCameraModalRubiks" // Unique ID
          ...
          />
          <label
            htmlFor="useIpCameraModalRubiks"
        ...
        {modalCameraSettings.useIpCamera && (
          <div className="mb-4">
            <label
              htmlFor="ipCameraUrlModalRubiks" // Unique ID
              className="block mb-1 text-sm font-medium text-gray-700"
            >
              IP Camera URL:
            </label>
            <input
              ref={ipCameraInputRef} // Use the passed ref
              type="text"
              id="ipCameraUrlModalRubiks" // Unique ID
...
export default function RubiksSolverPage() {
  ...
  }, [showSettings, modalCameraSettings.useIpCamera]);
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4 min-h-screen bg-gray-100 font-sans">
      <SettingsModalComponent
        ...
        modalCameraSettings={modalCameraSettings}
        setModalCameraSettings={setModalCameraSettings}
      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6 mt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => {
                ...
                setModalCameraSettings(appliedCameraSettings); // Initialize modal with current applied settings
        ...
        {!isSecureContext && !appliedCameraSettings.useIpCamera && (
        ...
        {appliedCameraSettings.useIpCamera &&
          appliedCameraSettings.ipCameraUrl && (
            <div className="mb-2 text-blue-600 text-sm p-2 bg-blue-100 border border-blue-300 rounded">
              Using IP Camera: {appliedCameraSettings.ipCameraUrl}
            </div>
          )}
